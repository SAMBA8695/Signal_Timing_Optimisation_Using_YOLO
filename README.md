...
Upload IFP.ipynb to Colab or open directly from GitHub.
...
The project supports remapping original dataset classes into a reduced/custom set.

A new YOLO-compatible dataset.yaml file is generated automatically.

Images and labels are reorganized for training and validation.
...
Detected vehicles are visualized with bounding boxes
